...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Jagadeesh Kota',", type: 'array-item' },
    { code: "    role: 'Software Developer',", type: 'array-item' },
    { code: "    bio: 'Building modern Android experiences'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          ...
          <p className={styles.bio}>
            I build elegant, responsive Android applications with modern
