  ...
  return (
    <div className={styles.container}>
      <div className={styles.content}>
        <h1 className={styles.title}>Jagadeesh Kota</h1>
        <div className={styles.subtitle}>Software Developer</div>

        <div className={styles.aboutContent}>
          <section className={styles.section}>
            <p className={styles.paragraph}>
              Hey! I&apos;m a software Developer from kerala, India. I primarily
              work with kotlin / flutter and the Android ecosystem.
            </p>
            <p className={styles.paragraph}>
